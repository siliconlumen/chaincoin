...
[From the chaincoin github repo](https://github.com/darkcoin/darkcoin/blob/master/doc/masternode_conf.md)
...
If you are using a masternode.conf file you no longer need the chaincoin.conf file. The exception is if you need custom settings (thanks oblox). 
