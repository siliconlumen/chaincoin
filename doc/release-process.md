...
##perform gitian builds
 ...
 Build chaincoind and chaincoin-qt on Linux32, Linux64, and Win32:

	./bin/gbuild --commit chaincoin=v${VERSION} ../chaincoin/contrib/gitian-descriptors/gitian-linux.yml
	./bin/gsign --signer $SIGNER --release ${VERSION} --destination ../gitian.sigs/ ../chaincoin/contrib/gitian-descriptors/gitian-linux.yml
	pushd build/out
	zip -r chaincoin-${VERSION}-linux-gitian.zip *
	mv chaincoin-${VERSION}-linux-gitian.zip ../../../
	popd
	./bin/gbuild --commit chaincoin=v${VERSION} ../chaincoin/contrib/gitian-descriptors/gitian-win.yml
	./bin/gsign --signer $SIGNER --release ${VERSION}-win --destination ../gitian.sigs/ ../chaincoin/contrib/gitian-descriptors/gitian-win.yml
	pushd build/out
	zip -r chaincoin-${VERSION}-win-gitian.zip *
	mv chaincoin-${VERSION}-win-gitian.zip ../../../
	popd
    ./bin/gbuild --commit chaincoin=v${VERSION} ../chaincoin/contrib/gitian-descriptors/gitian-osx-bitcoin.yml
