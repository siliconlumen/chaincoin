...
const char* BITCOIN_REQUEST_MIMETYPE = "application/chaincoin-paymentrequest";
const char* BITCOIN_PAYMENTACK_MIMETYPE = "application/chaincoin-paymentack";
const char* BITCOIN_PAYMENTACK_CONTENTTYPE = "application/chaincoin-payment";
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // chaincoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
                ...
                emit message(tr("URI handling"),
                    tr("URI can not be parsed! This can be caused by an invalid Chaincoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
